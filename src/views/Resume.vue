        ...
        <section class="services" id="resume">
            <div class="container">
                ...
                <div class="my-skills">
                    <div class="skill">
                        <!--h1>Resume</h1-->
                        <p class="global-link resume-file"><a href="./Resume_FabianFroding_2022c.docx" target="_blank"><i class="far fa-file-alt"/> Resume_FabianFroding_2022b.docx</a></p>
                        <p class="global-link resume-file"><a href="./Resume_FabianFroding_2022c.pdf" target="_blank"><i class="far fa-file-pdf"/> Resume_FabianFroding_2022b.pdf</a></p>
                    </div>
                </div>
                ...
                <div class="timeline">
                    <ul>
                        ...
                        <li class="date" data-date="2017 - 2020">
                            ...
                            <p>BSc in Software Engineering and Management</p>
                        </li>
                    </ul>
                </div>
            </div>
