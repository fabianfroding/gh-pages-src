<template>
    <div>
        <p>
            This project is an ongoing attempt on a metroidvania featuring a three-day cycle system inspired by the same system as in The Legend of Zelda: Majora's Mask.
        </p>
        <br><br>
        ...
        <p>
            ...
            <br><br>
            The game is still under early development, which is why some images shows varying sprites etc.
        </p>
